 ...
 * SECURITY WARNING: Use ONLY for operations that require bypassing RLS
 * Examples: Data seeding, admin operations, system tasks
 * 
 * NEVER expose this to client-side code or use for user-initiated actions
 */
